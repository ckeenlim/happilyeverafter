...
ActiveRecord::Schema.define(version: 20160402072533) do
  ...
  add_index "post_categories", ["category", "post_type"], name: "index_post_categories_on_category_and_post_type", using: :btree
