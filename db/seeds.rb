...
#new parentcategory and categories seed
VendorParentCategory.create!(id: 1, name: "Pre Wedding Needs")
VendorParentCategory.create!(id: 2, name: "Ceremony")
VendorParentCategory.create!(id: 3, name: "Venues")
VendorParentCategory.create!(id: 4, name: "Hotels")
VendorParentCategory.create!(id: 5, name: "Catering")
VendorParentCategory.create!(id: 6, name: "Photos & Videos")
VendorParentCategory.create!(id: 7, name: "Dress, Attire & Accesories")
VendorParentCategory.create!(id: 8, name: "Hair & Make-up")
VendorParentCategory.create!(id: 9, name: "Decoration & Lighting")
VendorParentCategory.create!(id: 10, name: "Wedding Planners")
VendorParentCategory.create!(id: 11, name: "Entertainment")
VendorParentCategory.create!(id: 12, name: "Wedding Cakes")
VendorParentCategory.create!(id: 13, name: "Rings & Jewelry")
VendorParentCategory.create!(id: 14, name: "Invitations")
VendorParentCategory.create!(id: 15, name: "Favors & Gifts")
VendorParentCategory.create!(id: 16, name: "Car Rentals")
VendorParentCategory.create!(id: 17, name: "Beauty & Wellness")
VendorParentCategory.create!(id: 18, name: "Post Wedding/Honeymoon")
VendorParentCategory.create!(id: 19, name: "Others/Unique Services")
Category.create!(id: 1, name: "Marriage Documents", parent_category_id: 1)
Category.create!(id: 2, name: "Marriage Preparation Programs", parent_category_id: 1)
Category.create!(id: 3, name: "Chinese Engagement", parent_category_id: 1)
Category.create!(id: 4, name: "Ceremony", parent_category_id: 2)
Category.create!(id: 5, name: "Venues", parent_category_id: 3)
Category.create!(id: 6, name: "Hotels", parent_category_id: 4)
Category.create!(id: 7, name: "Caterers", parent_category_id: 5)
Category.create!(id: 8, name: "Specialty Food Stations", parent_category_id: 5)
Category.create!(id: 9, name: "Wines & Spirits", parent_category_id: 5)
Category.create!(id: 10, name: "Photography", parent_category_id: 6)
Category.create!(id: 11, name: "Videography", parent_category_id: 6)
Category.create!(id: 12, name: "Album Suppliers", parent_category_id: 6)
Category.create!(id: 13, name: "Designers", parent_category_id: 7)
Category.create!(id: 14, name: "Men's Formal Wear", parent_category_id: 7)
Category.create!(id: 15, name: "Accesories", parent_category_id: 7)
Category.create!(id: 16, name: "Hair & Make-up", parent_category_id: 8)
Category.create!(id: 17, name: "Event Stylist", parent_category_id: 9)
Category.create!(id: 18, name: "Florists", parent_category_id: 9)
Category.create!(id: 19, name: "Lights & Sounds", parent_category_id: 9)
Category.create!(id: 20, name: "Projectors", parent_category_id: 9)
Category.create!(id: 21, name: "Wedding Planners", parent_category_id: 10)
Category.create!(id: 22, name: "Emcee", parent_category_id: 11)
Category.create!(id: 23, name: "Strings & Bands", parent_category_id: 11)
Category.create!(id: 24, name: "DJs", parent_category_id: 11)
Category.create!(id: 25, name: "Wedding Cakes", parent_category_id: 12)
Category.create!(id: 26, name: "Rings & Jewelry", parent_category_id: 13)
Category.create!(id: 27, name: "Caligraphy", parent_category_id: 14)
Category.create!(id: 28, name: "Invitations", parent_category_id: 14)
Category.create!(id: 29, name: "Favors & Gifts", parent_category_id: 15)
Category.create!(id: 30, name: "Car Rentals", parent_category_id: 16)
Category.create!(id: 31, name: "Beauty & Wellness", parent_category_id: 17)
Category.create!(id: 32, name: "Airlines", parent_category_id: 18)
Category.create!(id: 33, name: "Travel Agencies", parent_category_id: 18)
Category.create!(id: 34, name: "Proposals, Stags & Showers", parent_category_id: 19)
Category.create!(id: 35, name: "Engagement Stylist", parent_category_id: 19)
Category.create!(id: 36, name: "Photo Booths", parent_category_id: 19)
Category.create!(id: 37, name: "Mobile Bars", parent_category_id: 19)
Category.create!(id: 38, name: "Rentals", parent_category_id: 19)
